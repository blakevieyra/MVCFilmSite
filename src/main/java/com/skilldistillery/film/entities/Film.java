...
public class Film {
	...
	public String toString() {
		return "<ul><h3>ID: " + id + "</h3><li><h4>Title: " + title + "</h4></li><li>Description: " + description + "</li><li>Release Year: " + releaseYear + "</li><li>Rating: "
				+ rating + "</li><li>Language: " + language + "</li><li>Actors: " + actors + "</li></ul>";
	}
